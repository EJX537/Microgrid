...
const WidgetLayout: React.FC<WidgetLayoutProps> = ({ widgets, className = 'col-start-1 col-span-full' }) => {
	return (
		<div className={`${className} rounded-lg col-span-full shadow-sm flex flex-col p-4 justify-evenly pointer-events-none transition-all duration-300 ease-in-out transform group`}>
			{
